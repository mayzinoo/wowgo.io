...
exports.account = function(req, res, next) {
    ...
    async.parallel(tasks, function(err, ret) {
        ...
        let depositsSum = 0;
        let withdrawlsSum = 0;
	var gqcadd='0x61C663bDE14EFf4410Da01d33c0AFEE5BC8a871F';
	...
	//Getting eth_add from database
        ...
        console.log('krw kkkkkkkkkk', bankinfokrw)       
...
exports.handleDepositRequest = function(req, res, next) {
	...
	console.log('HHHHHHHHH', req.body.ethereum_amt);
	console.log('hhhhh',currency_amt);
        var wow_amt = '0';
        var deposit_name = '';
