define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            HOST: (window.document.location.host === 'www.bustabit.com' || window.DEV_OTT) ? 'https://g2.moneypot.com:443' : window.document.location.host.replace(/:2053$/, ':2096'),
           CHAT_HOST: window.document.location.host,
            //CHAT_HOST: 'http://localhost:2053',
            MAX_BET: 100000, /** Max bet per game 1,000,000 Bits, this will be calculated dynamically in the future, based on the invested amount in the casino **/
            MIN_BET:10
        },
        ...
        QuickBetAmountButton: {
            ...
            DEFAULT: 10,
            AUTO_CASH_OUT_AMOUNTS: [1.3,2,5,10,50],
            AUTO_CASH_OUT_DEFAULT: 2,
        },
