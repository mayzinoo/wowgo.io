define([
            ...
            //requestOtt(function(err) {
                ...
                self.ws.emit('join', 
                    function(err, resp) {
                        ...
                        console.log('gggggggggggggggg', self.gameState)
    ...
    Engine.prototype.stopgame = function() {
        self.gameState = 'ENDED';
        this.trigger('stopgame');
    };
    ...
    AppDispatcher.register(function(payload) {
        ...
        switch(action.actionType) {
            ...
            case AppConstants.ActionTypes.PLACE_BET:
             ...
             case AppConstants.ActionTypes.stopgame:
                EngineSingleton.stopgame();
                break;    
