...
define([
    ...
    return {
        ...
        parseBet: function(betStringBits) {
          return parseInt(betStringBits.toString().replace(/k/g, '000'));
        },
        ...
        canUserBet: function(balance, betStringBits, betInvalid, autoCashOutInvalid) {
